...
cp %{_builddir}/Class-Tiny-1.008/LICENSE %{buildroot}/usr/share/package-licenses/perl-Class-Tiny/e188c4892bc1fbfced62c2299a2a24fd21098d81
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.34.0/Class/Tiny.pm
